  ...
  return (
    <section>
      <Container className="py-16 md:py-24">
        <div className="rounded-[var(--radius-lg)] border border-border-token bg-surface-strong p-6 md:p-10">
          <div className="section-grid gap-8 md:grid-cols-[minmax(0,1fr)_minmax(280px,420px)] md:items-end">
            ...
            <form className="section-grid gap-3">
              ...
              <input
                ...
                className="h-12 rounded-full border border-border-token bg-input px-5 text-sm text-foreground outline-none placeholder:text-muted focus:border-accent-token"
              />
